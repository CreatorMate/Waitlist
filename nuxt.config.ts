...
export default defineNuxtConfig({
    ...
    modules: ['@nuxtjs/tailwindcss', '@nuxtjs/robots', '@nuxtjs/sitemap', "@nuxtjs/supabase", '@pinia/nuxt', 'nuxt-icon', '@nuxt/image', '@nuxt/icon', '@vueuse/nuxt', '@nuxtjs/cloudinary'],
    ...
    supabase: {
        ...
        redirectOptions: {
            login: '',
            callback: '/callback',
            exclude: ['/', '/callback', '/work', '/about-us', '/select-login']
        }
    },
