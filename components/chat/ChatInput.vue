...
<template>
    <div :class="[
        ...
        class="w-full px-4 md:px-0 flex items-center gap-2 flex-col sticky bottom-0 py-8 bg-black bg-opacity-60 backdrop-blur-[8px]">
           ...
           'border-zinc-600': disabled
               ...
               <textarea
                ...
                <div class="rounded-r-full bg-white bg-opacity-10 py-4 px-4">
                    <div @click="send"
                         class="arrow-icon cursor-pointer hover:text-opacity-0 text-white text-opacity-40">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <g clip-path="url(#clip0_117_717)">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                      ...
                                      fill="white" :fill-opacity="value.length != 0 ? 1 : 0.4"/>
                            </g>
                            <defs>
