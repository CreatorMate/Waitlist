...
import HomeExplenationBlock from "~/components/home/HomeExplenationBlock.vue";
</script>
...
<template>
    <section class="flex flex-col w-full px-3 lg:px-32 pt-24">
        ...
        <HomeButton class="mt-3 pl-0"></HomeButton>
        <div class="mt-24">
        ...
        <div class="flex flex-col lg:flex-row justify-between w-full mt-24">
            ...
            <div class="w-full lg:w-[653px] text-sm lg:text-lg font-medium">
                <p class="text-3xl lg:text-[64px] lg:leading-[48px] font-normal break-words">are from <span class="galica italic font-medium">amsterdam, berlin, london, los angeles, new york, </span> and many more places.</p>
                <p class="lg:mt-24 mt-12">amsterdam</p>
                <p class="mt-3">oudeschans 85</p>
                <p>1011kw, amsterdam</p>
                <p>the netherlands</p>
                <div class="w-fit">
                    <p class="mt-9 pb-2 border-b border-black mb-3 w-auto">interested?</p>
                </div>
            </div>
        </div>
    </section>
