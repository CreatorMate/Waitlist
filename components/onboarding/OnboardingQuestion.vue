<script setup lang='ts'>
    ...
    const emit = defineEmits(['done', 'resize', 'uploaded', 'save']);
...
<template>
    <div ref="elementRef">
        <AnimatedText v-if="question.type == OnboardingMessageType.AI || question.type ==  OnboardingMessageType.PICTURE || question.type == OnboardingMessageType.LAST" @done="done" :text="question.message"
